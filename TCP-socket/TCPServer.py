from socket import *
serverPort = 12000
serverSocket = socket(AF_INET, SOCK_STREAM) #创建TCP欢迎套接字，使用IPv4
serverSocket.bind(('',serverPort)) #将套接字绑定到指定端口
...
while True:
    ...
    connectionSocket.send(capitalizedSentence) #向客户发送修改后的字符串
